      ...
      <div class='dashboard-content'>
        <div class='bills-feed'>
          <div class='status-bills-header'>
            ...
            <span class='arrow-icon' id='arrow-icon1' data-testid='arrow-icon1' data-open='false'>${ArrowIcon}</span>
          </div>
          <div class='status-bills-container' id='status-bills-container1'>
            ...
            <div class='status-bills-header' style='margin-top: 20px;'>
              ...
              <span class='arrow-icon' id='arrow-icon2' data-testid='arrow-icon2' data-open='false'>${ArrowIcon}</span>
            </div>
            ...
            <div class='status-bills-header' style='margin-top: 20px;'>
              ...
              <span class='arrow-icon' id='arrow-icon3' data-testid='arrow-icon3' data-open='false'>${ArrowIcon}</span>
            </div>
